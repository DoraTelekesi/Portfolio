...
export class ReferenceItemComponent {
  ...
  //   // Highest z-index if hovered, otherwise default
  //   return this.hoveredIndex === index ? 999 : [9, 3, 1][index % 3];
  // }

  // getZIndexImg(index: number): number {
  //   return this.hoveredIndex === index ? 1000 : 1;
  // }
